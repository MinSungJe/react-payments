    ...
    <AppContainer>
      ...
      <div>
        <Announcement
          ...
          caption="본인 명의의 카드만 결제 가능합니다."></Announcement>
        <CardNumberForm cardInfo={cardInfo} handleCardInfo={handleCardInfo} maxLength={4} />
        <Announcement
          main="카드 유효기간을 입력해 주세요"
          caption="월/년도(MMYY)를 순서대로 입력해 주세요."></Announcement>
        <CardExpirationForm cardInfo={cardInfo} handleCardInfo={handleCardInfo} maxLength={2} />
        <Announcement main="CVC 번호를 입력해 주세요"></Announcement>
        <CardCVCForm cardInfo={cardInfo} handleCardInfo={handleCardInfo} maxLength={3} />
      </div>
    </AppContainer>
  );
}
