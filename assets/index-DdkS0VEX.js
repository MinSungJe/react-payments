...
function Title({ main, caption }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(S$7.AnnouncementContainer, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(S$7.MainTitle, { children: main }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(S$7.Caption, { children: caption ?? "" })
  ] });
}
const S$7 = {
  AnnouncementContainer: newStyled.div`
    display: flex;
    flex-direction: column;
    gap: 4px;
  `,
  MainTitle: newStyled.p`
    margin-top: 16px;
    font-size: 18px;
    font-weight: 700;
  `,
...
function useClickOutsideHandler(targetRef, executionFunction, ...additionalCondition) {
  reactExports.useEffect(() => {
    function handleClickOutside(e) {
      if (additionalCondition.every((condition) => condition) && targetRef.current && !targetRef.current.contains(e.target)) {
        executionFunction();
      }
    }
...
function DropdownInput({ value, setValue, options, placeholder }) {
  const [isOpen, setIsOpen] = reactExports.useState(false);
  const dropdownRef = reactExports.useRef(null);
  useClickOutsideHandler(dropdownRef, () => setIsOpen(false), isOpen);
  const isPlaceholder = value === "";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    S$6.DropdownInputContainer,
    {
      isOpen,
      onClick: () => setIsOpen((prev2) => !prev2),
      ref: dropdownRef,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(S$6.DropdownLabel, { isPlaceholder, children: isPlaceholder ? placeholder : value }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(S$6.DropdownIcon, { isOpen }),
        isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(S$6.DropdownOptionsContainer, { children: options.map((option, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(S$6.DropdownOption, { onClick: () => setValue(option), children: option }, index)) })
      ]
    }
  );
}
const S$6 = {
  DropdownInputContainer: newStyled.div`
    position: relative;
    display: flex;
    ...
    user-select: none;
  `,
  DropdownLabel: newStyled.p`
    color: ${({ isPlaceholder }) => isPlaceholder ? "#acacac" : "#000"};
  `,
  DropdownIcon: newStyled.div`
    width: 15px;
    height: 15px;
    border-radius: 2px;
  ...
  `,
  DropdownOptionsContainer: newStyled.div`
    position: absolute;
    width: 100%;
    top: 45px;
    left: 0px;
...
function BottomButton({ label, onClick }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(S$5.BottomButtonContainer, { onClick, children: label });
}
const S$5 = {
  BottomButtonContainer: newStyled.button`
...
function getCardType(cardFirstNumber) {
  for (const prefix2 of VISA_CARD_PREFIXES) {
    if (cardFirstNumber.startsWith(prefix2)) return "VISA";
  }
  for (const prefix2 of MASTER_CARD_PREFIXES) {
    if (cardFirstNumber.startsWith(prefix2)) return "MasterCard";
  }
  return "None";
}
...
const CardPreview = ({ cardNumber, company, expiration }) => {
  const cardType = getCardType(cardNumber[0]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(S$4.CardContainer, { company, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(S$4.CardHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(S$4.CardIC, {}),
      cardType !== "None" && /* @__PURE__ */ jsxRuntimeExports.jsx(S$4.CardType, { src: CARD_TYPE_PATH[cardType], alt: cardType })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(S$4.CardInfo, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: getMaskedCardNumber(cardNumber).join(" ") }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: expiration.year === "" ? expiration.month : `${expiration.month} / ${expiration.year}` })
    ] })
  ] });
};
const S$4 = {
  CardContainer: newStyled.div`
    width: 212px;
    height: 132px;
    ...
    margin-bottom: 30px;
  `,
  CardHeader: newStyled.div`
    display: flex;
    justify-content: space-between;
    margin-bottom: 14px;
  `,
  CardIC: newStyled.div`
    width: 36px;
    height: 22px;
    background: #ddcd78;
    border-radius: 2px;
  ...
  `,
  CardType: newStyled.img`
    width: 36px;
    height: 22px;
  `,
  CardInfo: newStyled.div`
    display: flex;
    flex-direction: column;
    gap: 8px;
...
const Label = newStyled.p`
  ...
  margin-bottom: 8px;
`;
const NumberInputContainer = newStyled.div`
  display: flex;
  gap: 10px;
  margin-bottom: 8px;
`;
...
const PASSWORD_FRONT_MESSAGE = {
  MAIN: "비밀번호를 입력해 주세요",
  CAPTION: "앞의 2자리를 입력해주세요"
};
const CONFIRM_BUTTON_LABEL = "확인";
const ERROR_MESSAGE = {
  GET_LENGTH_TEXT: (length2) => `${length2}자의 숫자만 입력 가능합니다.`,
  INVALID_MONTH: "01에서 12사이의 숫자를 입력해주세요.",
  INVALID_YEAR: "만료된 기간입니다. 현재보다 이후 기간을 입력해주세요."
};
function isZeroOrExactLength(target, length2) {
  return target.length === 0 || target.length === length2;
}
function useCardCVCValidation(cardInfo, maxLength) {
...
function isOverThanToday(month, year) {
  return /* @__PURE__ */ new Date() < new Date(2e3 + year, month - 1);
}
function useCardExpirationValidation(cardInfo, maxLength) {
  ...
  const isYearError = !isZeroOrExactLength(year, maxLength) || month !== "" && year !== "" && !isValidYear;
...
function CardExpirationForm({ cardInfo, handleCardInfo, maxLength }) {
  ...
  const ExpirationInputInfo = [
    {
      ...
      setValue: (value) => handleCardInfo("expiration", value, "month"),
      placeholder: "MM",
      autoFocus: true
    },
    {
      value: cardInfo.expiration.year,
      setValue: (value) => handleCardInfo("expiration", value, "year"),
      placeholder: "YY"
    }
  ];
  function handleChange(value, index) {
    ...
    const { isCardExpirationError: isCardExpirationError2 } = useCardExpirationValidation(
      { ...cardInfo, expiration: updatedExpiration },
      maxLength
    );
    if (value.length === maxLength && !isCardExpirationError2[index]) {
      if (index === inputRefs.current.length - 1) (_a = inputRefs.current[index]) == null ? void 0 : _a.blur();
      else (_b = inputRefs.current[index + 1]) == null ? void 0 : _b.focus();
    }
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(NumberInputForm, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "유효기간" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(NumberInputContainer, { children: ExpirationInputInfo.map((inputInfo, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      NumberInput,
      {
...
function useCardNumberValidation(cardInfo, maxLength) {
...
function CardNumberForm({ cardInfo, handleCardInfo, maxLength }) {
  ...
  const NumberInputInfo = [
    {
      ...
      setValue: (value) => handleCardInfo("number", value, "first"),
      autoFocus: true
    },
    {
      value: cardInfo.number.second,
      setValue: (value) => handleCardInfo("number", value, "second")
    },
    {
      value: cardInfo.number.third,
      setValue: (value) => handleCardInfo("number", value, "third")
    },
    {
      value: cardInfo.number.fourth,
      setValue: (value) => handleCardInfo("number", value, "fourth")
    }
  ];
  function handleChange(value, index) {
    var _a, _b;
    ...
    const { isCardNumberError: isCardNumberError2 } = useCardNumberValidation(
      { ...cardInfo, number: updatedCardNumber },
      maxLength
    );
    if (value.length === maxLength && !isCardNumberError2[index]) {
      if (index === inputRefs.current.length - 1) (_a = inputRefs.current[index]) == null ? void 0 : _a.blur();
      else (_b = inputRefs.current[index + 1]) == null ? void 0 : _b.focus();
    }
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(NumberInputForm, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(NumberInputContainer, { children: NumberInputInfo.map((inputInfo, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      NumberInput,
      {
        value: inputInfo.value,
        setValue: (value) => handleChange(value, index),
...
function useCardPasswordValidation(cardInfo, maxLength) {
...
function CardPasswordForm({ cardInfo, handleCardInfo, maxLength }) {
  const { isCardPasswordError, errorText } = useCardPasswordValidation(cardInfo, maxLength);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(NumberInputForm, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "비밀번호 앞 2자리" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(NumberInputContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      NumberInput,
      {
...
function useCardInfo() {
  ...
  function handleCardInfo(field, value, subfield) {
...
function useCardInfoValidation(cardInfo) {
  ...
  return isCardNumberError.some((isError) => isError) || isCardExpirationError.some((isError) => isError) || isCardCVCError || isCardPasswordError || isSomeEmptyValue;
}
function useStep(initValue) {
  const [step, setStep] = reactExports.useState(initValue);
  function increaseStep() {
    setStep((prev2) => prev2 + 1);
  }
  return { step, increaseStep };
}
function useDynamicRenderingStep(cardInfo) {
  ...
  const conditionsByStep = [
    !isCardNumberError.some((isError) => isError) && !Object.values(cardInfo.number).some((value) => value === ""),
    cardInfo.company !== "",
    !isCardExpirationError.some((isError) => isError) && !Object.values(cardInfo.expiration).some((value) => value === ""),
...
function RegisterCardPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(S$2.FormContainer, { children: [
      step >= 4 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { main: PASSWORD_FRONT_MESSAGE.MAIN, caption: PASSWORD_FRONT_MESSAGE.CAPTION }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          CardPasswordForm,
          {
            cardInfo,
      ...
      step >= 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { main: CVC_MESSAGE.MAIN }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          CardCVCForm,
          {
            cardInfo,
      ...
      step >= 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { main: EXPIRATION_MESSAGE.MAIN, caption: EXPIRATION_MESSAGE.CAPTION }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          CardExpirationForm,
          {
            cardInfo,
      ...
      step >= 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { main: CARD_COMPANY_MESSAGE.MAIN, caption: CARD_COMPANY_MESSAGE.CAPTION }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          DropdownInput,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { main: CARD_NUMBER_MESSAGE.MAIN, caption: CARD_NUMBER_MESSAGE.CAPTION }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        CardNumberForm,
        {
          cardInfo,
    ...
    !isCardInfoError && /* @__PURE__ */ jsxRuntimeExports.jsx(
      BottomButton,
      {
...
function CompletePage() {
  ...
  const navigate = useNavigate();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(S$1.CompleteImgContainer, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(S$1.DescriptionContainer, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        state.cardInfo.number.first,
        "로 시작하는"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        state.cardInfo.company,
        "가 등록되었어요."
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(S$1.ConfirmButton, { onClick: () => navigate(ROUTER_PATH.MAIN), children: "확인" })
  ] });
}
const S$1 = {
  CompleteImgContainer: newStyled.div`
    width: 76px;
    height: 76px;
    ...
    margin-bottom: 25px;
  `,
  DescriptionContainer: newStyled.div`
    text-align: center;
    font-size: 25px;
    font-weight: 700;
    color: #353c49;
    margin-bottom: 25px;
  `,
  ConfirmButton: newStyled.button`
    width: 100%;
    border-radius: 5px;
  `
};
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(S.AppContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: ROUTER_PATH.MAIN, element: /* @__PURE__ */ jsxRuntimeExports.jsx(RegisterCardPage, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: ROUTER_PATH.COMPLETE, element: /* @__PURE__ */ jsxRuntimeExports.jsx(CompletePage, {}) })
  ] }) });
}
const S = {
  AppContainer: newStyled.div`
    width: ${VIEWPORT.MOBILE}px;
    height: 100vh;
    display: flex;
    flex-direction: column;
